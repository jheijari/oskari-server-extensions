 ...
 */
public class V1_1_1__Add_vectorlayer_support implements JdbcMigration {

    private static final Logger LOG = LogFactory.getLogger(V1_1_1__Add_vectorlayer_support.class);
