 ...
 */
public class V1_5_1__Add_marker_support implements JdbcMigration {

    private static final Logger LOG = LogFactory.getLogger(V1_5_1__Add_marker_support.class);

    private ViewService service;
    private static final int BATCH_SIZE = 50;
    private int updatedViewCount = 0;

    private static final String PLUGIN_NAME = "Oskari.mapframework.mapmodule.MarkersPlugin";
